; --------FED_TAXES_PAID_INPUT-------
; Asks for fed state taxes paid. Stores the value in FED_PAID.

			.ORIG x3500
							;
							; Prints message for fed taxes paid
...
FED_TEN
			...
			AND	R2, R2, 0
							;
							; Add hundreds, tens, and ones together. Store in FED_TAXES_1
...
FED_MESSAGE	.STRINGZ "Fed taxes paid to nearest dollar in range(0-30,000)(e.g. 06400):"
